        ...
        polyfill: function () {
          ...
          function f(e) {
            var i,
              ...
              r,
              l = (o() - e.startTime) / 468;
            (r = l = l > 1 ? 1 : l), (i = 0.5 * (1 - Math.cos(Math.PI * r))), (s = e.startX + (e.x - e.startX) * i), (n = e.startY + (e.y - e.startY) * i), e.method.call(e.scrollable, s, n), (s === e.x && n === e.y) || t.requestAnimationFrame(f.bind(t, e));
          }
          function p(i, s, r) {
            var a,
              c,
